...
# -*- coding: utf-8 -*-
"""
Train a Transformer to classify wrench time-series chunks into a 6D label vector (classes 0..4 per dimension).
...
Usage:
Configure the config dict below and run: python train.py
...
def main():
    ...
    # Initialize wandb
    wandb_name = config["wandb_name"] or f"rcc_transformer_{config['window']}w_{config['stride']}s"
    wandb.init(
